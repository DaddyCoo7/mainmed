...
const STATIC_ROUTES = [
  ...
  { path: 'medical-billing-services', title: 'Medical Billing Services by State | All 50 States | Medtransic', description: 'Find expert medical billing services in your state. Medtransic provides professional RCM solutions, claims management, and revenue optimization across all 50 states.' },
