...
const OrthopedicsPage: React.FC = () => {
  const painPoints = [
    {
      ...
      description: 'Orthopedic surgeries have 90-day global periods where most related services are bundled, requiring careful tracking to avoid denials.',
    ...
    },
    {
      ...
      description: 'Work-related orthopedic injuries involve different coding requirements, fee schedules, and authorization processes than standard insurance.',
    ...
    },
    {
      ...
      description: 'Orthopedic practices often provide in-office imaging requiring technical and professional component billing with proper modifiers.',
  ...
  const solutions = [
    {
      icon: Bone,
      title: 'Orthopedic Surgery Billing Specialists',
      description: 'Our team includes certified coders with specialized training in orthopedic procedures, global period management, and implant billing.',
      benefits: [
        'Expert CPT coding for all orthopedic procedures',
    ...
    },
    {
      ...
      benefits: [
        ...
        'HCPCS code expertise for orthopedic supplies',
    ...
    },
    {
      ...
      description: 'Specialized knowledge of workers comp billing requirements, fee schedules, and authorization processes for orthopedic injuries.',
      benefits: [
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Accurate billing for joint injections, trigger point injections, and in-office orthopedic procedures.',
    ...
    },
    {
      ...
      features: ['X-ray technical/professional split', 'Ultrasound guidance (76942)', 'Bone density scanning', 'Modifier 26 and TC application']
    },
    {
      icon: Wrench,
      title: 'Hardware & Implant Billing',
      description: 'Specialized billing for orthopedic implants, plates, screws, prosthetics, and surgical hardware.',
  ...
  return (
    <>
      <SEOHead
        title="Orthopedic Billing Services | Joint Replacement & Fracture Care RCM"
      ...
      <HeroSection
        badge={{
          icon: Bone,
          text: "Orthopedic Surgery Billing Specialists"
        }}
        title="Expert Orthopedic Billing Services"
        description="Maximize your orthopedic practice revenue with specialized billing expertise in surgical procedures, implant billing, and global period management. Our certified orthopedic billing specialists understand complex fracture care, arthroscopy bundling, and workers compensation requirements unique to musculoskeletal practices."
        buttons={[
      ...
      <div className="relative bg-white">
        ...
        <AnimatedSection animation="slideUp" className="mb-24">
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Orthopedic practices face unique billing complexities with surgical global periods,
        ...
        <AnimatedSection animation="slideUp" className="mb-24">
          <div className="text-center mb-16">
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              How Medtransic Solves Your Orthopedic Billing Challenges
            </motion.h2>
            <motion.p
              className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              ...
              viewport={{ once: true }}
            >
              Our specialized orthopedic billing solutions address each challenge with
              musculoskeletal-specific expertise and proven methodologies.
            </motion.p>
          </div>
        ...
        <AnimatedSection animation="slideUp" className="mb-24">
          <div className="text-center mb-16">
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              Specialized Orthopedic Billing Services
            </motion.h2>
            <motion.p
              className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              ...
              viewport={{ once: true }}
            >
              Comprehensive billing solutions tailored specifically for orthopedic surgery practices
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-12 shadow-xl border border-slate-200">
            <div className="text-center mb-12">
              <motion.h2
                ...
                viewport={{ once: true }}
              >
                Proven Results for Orthopedic Practices
              </motion.h2>
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Our specialized orthopedic billing expertise delivers measurable improvements in revenue
                and operational efficiency for musculoskeletal practices.
              </motion.p>
            </div>
          ...
          <div className="bg-white rounded-2xl p-12 shadow-xl border border-gray-100">
            <div className="text-center">
              ...
              <blockquote className="text-2xl text-gray-700 leading-relaxed italic mb-8 max-w-4xl mx-auto">
                "Managing billing for an orthopedic surgery practice is incredibly complex with global periods,
                implant billing, and workers compensation claims. Medtransic's team has deep expertise in
                orthopedic coding and has helped us recover costs on high-value implants that we were previously
                missing. Their global period tracking system alone has increased our revenue by 28%. They truly
                understand the unique challenges of orthopedic billing."
              </blockquote>
              <div className="border-t border-gray-200 pt-6">
                <p className="font-bold text-gray-900 text-lg">Dr. James Patterson, MD</p>
                <p className="text-slate-600 font-medium">Board-Certified Orthopedic Surgeon</p>
                <p className="text-gray-500">Summit Orthopedics & Sports Medicine</p>
              </div>
            </div>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection animation="slideUp" className="mb-24">
          <RelatedServices services={getRelatedLinks('orthopedics')} />
        </AnimatedSection>
        ...
        <AnimatedSection animation="slideUp" className="text-center">
          <div className="bg-white rounded-2xl p-12 shadow-xl border border-gray-100">
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              Ready to Optimize Your Orthopedic Practice Revenue?
            </motion.h2>
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Let our orthopedic billing specialists analyze your current processes and show you how we can
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
              ...
              >
                <Link to="/contact" className="bg-slate-600 text-white px-12 py-5 rounded-full hover:bg-slate-700 transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-xl font-semibold text-xl flex items-center justify-center">
                  ...
                  Schedule Free Orthopedic Consultation
                </Link>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05, y: -2 }}
            ...
            <div className="pt-8 border-t border-gray-200">
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div className="flex items-center justify-center">
                  ...
                  <span className="text-gray-700 font-medium">Orthopedic-Certified Coders</span>
                </div>
                <div className="flex items-center justify-center">
        ...
        <div className="text-center mt-12">
          <Link to="/specialties" className="text-slate-600 hover:text-slate-700 font-semibold text-lg flex items-center justify-center">
