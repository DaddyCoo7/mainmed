...
const DiagnosticImagingRadiologyPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-medtransic-gradient relative overflow-hidden pt-20">
      <SEOHead
        title="Radiology Billing Services | Diagnostic Imaging Medical Billing"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <AnimatedSection animation="slideUp" className="mb-24">
          <RelatedServices services={getRelatedLinks('radiology')} />
        </AnimatedSection>
...
export default DiagnosticImagingRadiologyPage;
